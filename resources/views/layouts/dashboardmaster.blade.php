											...
											<div class="card-body d-flex flex-column justify-content-end pe-0">
												...
												<div class="symbol-group symbol-hover flex-nowrap">
													...
													<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Michael Eberon">
														<img alt="Pic" src="{{ asset('dashboard_assets') }}/media/avatars/300-11.jpg" />
													</div>
													<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Susan Redwood">
														<span class="symbol-label bg-primary text-inverse-primary fw-bolder">S</span>
													</div>
													<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Melody Macy">
														<img alt="Pic" src="{{ asset('dashboard_assets') }}/media/avatars/300-2.jpg" />
													</div>
												...
												<ul class="nav nav-pills nav-pills-custom mb-3">
													...
													<li class="nav-item mb-3 me-3 me-lg-6">
														...
														<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_1">
															<!--begin::Icon-->
															<div class="nav-icon">
																<img alt="" src="{{ asset('dashboard_assets') }}/media/svg/products-categories/t-shirt.svg" class="" />
															</div>
															<!--end::Icon-->
															<!--begin::Subtitle-->
													...
													<li class="nav-item mb-3 me-3 me-lg-6">
														...
														<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_2">
															<!--begin::Icon-->
															<div class="nav-icon">
																<img alt="" src="{{ asset('dashboard_assets') }}/media/svg/products-categories/gaming.svg" class="" />
															</div>
															<!--end::Icon-->
															<!--begin::Subtitle-->
													...
													<li class="nav-item mb-3 me-3 me-lg-6">
														...
														<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_3">
															<!--begin::Icon-->
															<div class="nav-icon">
																<img alt="" src="{{ asset('dashboard_assets') }}/media/svg/products-categories/watch.svg" class="" />
															</div>
															<!--end::Icon-->
															<!--begin::Subtitle-->
													...
													<li class="nav-item mb-3 me-3 me-lg-6">
														...
														<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_4">
															<!--begin::Icon-->
															<div class="nav-icon">
																<img alt="" src="{{ asset('dashboard_assets') }}/media/svg/products-categories/gloves.svg" class="nav-icon" />
															</div>
															<!--end::Icon-->
															<!--begin::Subtitle-->
													...
													<li class="nav-item mb-3">
														...
														<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_5">
															<!--begin::Icon-->
															<div class="nav-icon">
																<img alt="" src="{{ asset('dashboard_assets') }}/media/svg/products-categories/shoes.svg" class="nav-icon" />
															</div>
															<!--end::Icon-->
															<!--begin::Subtitle-->
														...
														<div class="table-responsive">
															...
															<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
																...
																<tbody>
																	<tr>
																		<td>
																			<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/210.gif" class="w-50px ms-n1" alt="" />
																		</td>
																		<td class="ps-0">
																	...
																	<tr>
																		<td>
																			<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/215.gif" class="w-50px ms-n1" alt="" />
																		</td>
																		<td class="ps-0">
																	...
																	<tr>
																		<td>
																			<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/209.gif" class="w-50px ms-n1" alt="" />
																		</td>
																		<td class="ps-0">
														...
														<div class="table-responsive">
															...
															<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
																...
																<tbody>
																	<tr>
																		<td>
																			<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/197.gif" class="w-50px ms-n1" alt="" />
																		</td>
																		<td class="ps-0">
																			<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
																			<span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Item: #XDG-4312</span>
																	...
																	<tr>
																		<td>
																			<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/178.gif" class="w-50px ms-n1" alt="" />
																		</td>
																		<td class="ps-0">
																			<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
																	...
																	<tr>
																		<td>
																			<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/22.gif" class="w-50px ms-n1" alt="" />
																		</td>
																		<td class="ps-0">
																			<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
														...
														<div class="table-responsive">
															...
															<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
																...
																<tbody>
																	<tr>
																		<td>
																			<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/1.gif" class="w-50px ms-n1" alt="" />
																		</td>
																		<td class="ps-0">
																	...
																	<tr>
																		<td>
																			<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/24.gif" class="w-50px ms-n1" alt="" />
																		</td>
																		<td class="ps-0">
																			<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
																	...
																	<tr>
																		<td>
																			<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/71.gif" class="w-50px ms-n1" alt="" />
																		</td>
																		<td class="ps-0">
																			<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
														...
														<div class="table-responsive">
															...
															<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
																...
																<tbody>
																	<tr>
																		<td>
																			<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/41.gif" class="w-50px ms-n1" alt="" />
																		</td>
																		<td class="ps-0">
																	...
																	<tr>
																		<td>
																			<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/63.gif" class="w-50px ms-n1" alt="" />
																		</td>
																		<td class="ps-0">
																			<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
																	...
																	<tr>
																		<td>
																			<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/59.gif" class="w-50px ms-n1" alt="" />
																		</td>
																		<td class="ps-0">
																			<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
														...
														<div class="table-responsive">
															...
															<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
																...
																<tbody>
																	<tr>
																		<td>
																			<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/10.gif" class="w-50px ms-n1" alt="" />
																		</td>
																		<td class="ps-0">
																	...
																	<tr>
																		<td>
																			<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/96.gif" class="w-50px ms-n1" alt="" />
																		</td>
																		<td class="ps-0">
																	...
																	<tr>
																		<td>
																			<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/13.gif" class="w-50px ms-n1" alt="" />
																		</td>
																		<td class="ps-0">
										...
										<div class="card h-md-100">
											...
											<div class="card-body d-flex flex-column flex-center">
												...
												<div class="mb-2">
													...
													<!--end::Title-->
													<!--begin::Illustration-->
													<div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center card-rounded-bottom h-200px mh-200px my-5 my-lg-12" style="background-image:url('{{ asset('dashboard_assets') }}/media/svg/illustrations/easy/2.svg')"></div>
													<!--end::Illustration-->
												</div>
												<!--end::Heading-->
												<!--begin::Links-->
															...
															<td colspan="2">
																<div class="d-flex align-items-center gap-3">
																	<a href="#" class="symbol symbol-50px bg-secondary bg-opacity-25 rounded">
																		<img src="" data-kt-src-path="{{ asset('dashboard_assets') }}/media/stock/ecommerce/" alt="" data-kt-table-widget-4="template_image" />
																	</a>
												...
												<div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
													...
													<div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
														...
														<div class="d-flex flex-stack mb-3">
															...
															<div class="me-3">
																<!--begin::Icon-->
																<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/210.gif" class="w-50px ms-n1 me-1" alt="" />
																<!--end::Icon-->
																<!--begin::Title-->
													...
													<div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
														...
														<div class="d-flex flex-stack mb-3">
															...
															<div class="me-3">
																<!--begin::Icon-->
																<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/209.gif" class="w-50px ms-n1 me-1" alt="" />
																<!--end::Icon-->
																<!--begin::Title-->
													...
													<div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
														...
														<div class="d-flex flex-stack mb-3">
															...
															<div class="me-3">
																<!--begin::Icon-->
																<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/214.gif" class="w-50px ms-n1 me-1" alt="" />
																<!--end::Icon-->
																<!--begin::Title-->
													...
													<div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
														...
														<div class="d-flex flex-stack mb-3">
															...
															<div class="me-3">
																<!--begin::Icon-->
																<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/211.gif" class="w-50px ms-n1 me-1" alt="" />
																<!--end::Icon-->
																<!--begin::Title-->
																<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bolder">Elephant 1802</a>
																<!--end::Title-->
													...
													<div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
														...
														<div class="d-flex flex-stack mb-3">
															...
															<div class="me-3">
																<!--begin::Icon-->
																<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/215.gif" class="w-50px ms-n1 me-1" alt="" />
																<!--end::Icon-->
																<!--begin::Title-->
																<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bolder">RiseUP</a>
																<!--end::Title-->
													...
													<div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3">
														...
														<div class="d-flex flex-stack mb-3">
															...
															<div class="me-3">
																<!--begin::Icon-->
																<img src="{{ asset('dashboard_assets') }}/media/stock/ecommerce/192.gif" class="w-50px ms-n1 me-1" alt="" />
																<!--end::Icon-->
																<!--begin::Title-->
																<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bolder">Yellow Stone</a>
																<!--end::Title-->
