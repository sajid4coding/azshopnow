...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
								...
								<div class="menu-item @if ($current_page == 'dashboard') here show @endif menu-accordion">
									<span class="menu-link">
										<span class="menu-icon">
                                ...
                                {{-- PRODUCT ALL FUNCTIONALITY MANGE START HERE --}}
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                            <span class="menu-link">
                                                ...
                                                <span class="menu-title">Manage Product Discussion</span>
                                                <span class="menu-arrow"></span>
                                            </span>
                                ...
                                {{-- PRODUCT ALL FUNCTIONALITY MANGE END HERE --}}



                                {{-- ORDER ALL FUNCTIONALITY MANGE START HERE --}}
                                ...
                                @can ('admin-Earnings')
                                    <div data-kt-menu-trigger="click" class="menu-item  menu-accordion">
    									<span class="menu-link">
    										...
    										<span class="menu-title">Manage Earnings</span>
    										<span class="menu-arrow"></span>
    									</span>
                                ...
                                {{-- ORDER ALL FUNCTIONALITY MANGE END HERE --}}



                                {{-- SYSTEM ALL FUNCTIONALITY MANGE START HERE --}}
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
     									...
     									<div class="menu-sub menu-sub-accordion menu-active-bg @if ($current_page == 'logo-edit' || $current_page == 'dashboard-website-content' || $current_page == 'dashboard-slider' || $current_page == 'dashboard-social-link' || $current_page == 'dashboard-contact-info' || $current_page == 'banner-edit' || $current_page == 'payment-setting') here show @endif">
                                            ...
                                            <div class="menu-item menu-accordion @if ($current_page == 'dashboard-social-link') here show @endif">
                                                <a class="menu-link" href="{{ route('general.social.link') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item menu-accordion @if ($current_page == 'dashboard-contact-info') here show @endif">
                                                <a class="menu-link" href="{{ route('general.contact.info') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item menu-accordion  @if ($current_page == 'banner-edit') here show @endif">
                                            ...
                                            {{-- <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                        <div class="menu-item menu-accordion @if ($current_page == 'dashboard-contact-info') here show @endif">
                                                            <a class="menu-link" href="{{ route('401.error') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">401 page</span>
                                                            </a>
                                                        </div>
                                                        <div class="menu-item menu-accordion @if ($current_page == 'dashboard-contact-info') here show @endif">
                                                            <a class="menu-link" href="{{ route('403.error') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">403 page</span>
                                                            </a>
                                                        </div>
                                                        <div class="menu-item menu-accordion @if ($current_page == 'dashboard-contact-info') here show @endif">
                                                            <a class="menu-link" href="{{ route('404.error') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item menu-accordion @if ($current_page == 'dashboard-contact-info') here show @endif">
                                                            <a class="menu-link" href="{{ route('502.error') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">502 page</span>
                                                            </a>
                                                        </div>
                                                        <div class="menu-item menu-accordion @if ($current_page == 'dashboard-contact-info') here show @endif">
                                                            <a class="menu-link" href="{{ route('503.error') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">503 page</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                @can('admin-delivery boy Management')
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                            <span class="menu-link">
                                                <span class="menu-icon">
                                ...
                                @can('admin-announcement Management')
                                    <div class="menu-item @if ($current_page == 'announcement') here show @endif menu-accordion">
                                        <span class="menu-link">
                                            ...
                                            <a href="{{ route('announcement.index') }}" class="menu-title">Manage Announcement</a>
                                        </span>
                                    </div>
                                @endcan

                                @can ('admin-Shipping')
                                    <div class="menu-item @if ($current_page == 'shipping') here show @endif menu-accordion">
                                        <span class="menu-link">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                                <span class="svg-icon svg-icon-2">
                                            ...
                                            <a href="{{ route('shipping.index') }}" class="menu-title">Manage Shipping</a>
                                        </span>
                                    </div>
                                @endcan
                                ...
                                @can ('admin-Packaging')
                                    <div class="menu-item @if ($current_page == 'packaging') here show @endif menu-accordion">
    									<span class="menu-link">
    										...
    										<a href="{{ route('packaging.index') }}" class="menu-title">Manage Packaging</a>
    									</span>
    								</div>
                                @endcan
                                ...
                                @can ('admin-Newsletter Management')
                                    <div class="menu-item @if ($current_page == 'newsletter-list') here show @endif menu-accordion">
    									<span class="menu-link">
    										...
    										<a href="{{ route('newsletters') }}" class="menu-title">Manage Subscriber</a>
    									</span>
    								</div>
                                @endcan

                                {{-- SYSTEM ALL FUNCTIONALITY MANGE END HERE --}}



                                {{-- APP ALL FUNCTIONALITY MANGE START HERE --}}
                                ...
                                @can ('admin-Admin Management')
                                    <div class="menu-item @if ($current_page == 'adminmanagement') here show @endif menu-accordion">
                                        <span class="menu-link">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                                <span class="svg-icon svg-icon-2">
                                            ...
                                            <a href="{{ route('adminmanagement.index') }}" class="menu-title">Manage Admins</a>
                                        </span>
                                    </div>
                                @endcan
                                            ...
                                            <div class="menu-sub menu-sub-accordion menu-active-bg @if ($current_page == 'vendormanagement' || $current_page == 'commission' || $current_page == 'payout' || $current_page == 'payout-request') here show @endif">
                                                ...
                                                <div class="menu-item @if ($current_page == 'payout-request') here show @endif">
                                                    <a class="menu-link" href="{{ route('payout.request') }}">
                                                        ...
                                                        <span class="menu-title" style="position: relative;">Payout Request @if (payout_request_pending() != 0) <span class="bullet bullet-dot bg-danger h-6px w-6px position-absolute top-0 animation-blink" style="right: 70px"></span> @endif</span>
                                                    </a>
                                                </div>
                                ...
                                @can ('admin-Customer Management')
                                    <div class="menu-item @if ($current_page == 'customermanagement') here show @endif menu-accordion">
                                        <span class="menu-link">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                                <span class="svg-icon svg-icon-2">
                                            ...
                                            <a href="{{ route('customermanagement.index') }}" class="menu-title">Manage Customers</a>
                                        </span>
                                    </div>
                                @endcan
                                ...
                                {{-- APP ALL FUNCTIONALITY MANGE END HERE --}}
									...
									<div class="d-flex align-items-center ms-1 ms-lg-3">
										...
										<div class="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                            <span class="badge bg-light text-dark">
                                                <i class="fas fa-bell" style="font-size: 20px !important"></i>
                                                @if (auth()->user()->unreadNotifications()->groupBy('notifiable_id')->count())
                                                    <span class="bullet bullet-dot bg-success h-6px w-6px position-absolute translate-middle top-0 start-50 animation-blink"></span>
                                                @endif
                                               <span class="badge bg-warning text-dark"> {{auth()->user()->unreadNotifications()->groupBy('notifiable_id')->count()}}</span>
                                            </span>
											<!--end::Svg Icon-->
										</div>
										<!--begin::Menu-->
										<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
											...
											<div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{ asset('dashboard_assets') }}/media/misc/pattern-1.jpg')">
												...
												<ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-bold px-9">
													...
													<li class="nav-item">
														<a class="nav-link text-white opacity-75 opacity-state-100 pb-4" data-bs-toggle="tab" href="#kt_topbar_notifications_4">Product Return</a>
													</li>
												</ul>
												<!--end::Tabs-->
											</div>
											...
											<div class="tab-content">
												...
												<div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
													...
													<div class="scroll-y mh-325px my-5 px-8">
														<!--begin::Item-->
														@forelse (auth()->user()->unreadnotifications->where('type','App\Notifications\VendorRegisterNotification') as $notification)
													...
													<div class="py-3 text-center border-top">
														<div style="float: left">
                                                            <a href="{{route('all.notification')}}" class="btn btn-color-gray-600 btn-active-color-primary">View All
                                                        ...
                                                        <div>
                                                            <a href="{{route('markasread')}}" class="btn btn-color-gray-600"> Mark as Read </a>
                                                        </div>
													</div>
													<!--end::View more-->
												</div>
												...
												<div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
													<div class="scroll-y mh-325px my-5 px-8">
														<!--begin::Item-->
														@forelse (auth()->user()->unreadnotifications->where('type','App\Notifications\ProductNotification') as $notification)
                                                            <div class="d-flex flex-stack py-4">
                                                                <!--begin::Section-->
                                                                <div class="d-flex align-items-center">
                                                                    <!--begin::Symbol-->
                                                        ...
                                                        @empty
                                                            No Unread Product Notification
                                                        @endforelse
                                                    ...
                                                    <div class="py-3 text-center border-top">
                                                        ...
                                                        <div>
                                                            <a href="{{route('productmarkasread')}}" class="btn btn-color-gray-600"> Mark as Read </a>
                                                        </div>
                                                    </div>
												</div>
												<!--end::Tab panel-->
												...
												<div class="tab-pane fade" id="kt_topbar_notifications_3" role="tabpanel">
                                                    <div class="scroll-y mh-325px my-5 px-8">
														<!--begin::Item-->
														@forelse (auth()->user()->unreadnotifications->where('type','App\Notifications\OrderNotification') as $notification)
                                                            <div class="d-flex flex-stack py-4">
                                                                <!--begin::Section-->
                                                                <div class="d-flex align-items-center">
                                                                    <!--begin::Symbol-->
                                                    ...
                                                    <div class="py-3 text-center border-top">
                                                        ...
                                                        <div>
                                                            <a href="{{route('ordermarkasread')}}" class="btn btn-color-gray-600"> Mark as Read </a>
                                                        </div>
                                                    </div>
													<!--end::Items-->
												</div>
												<div class="tab-pane fade" id="kt_topbar_notifications_4" role="tabpanel">
                                                    <div class="scroll-y mh-325px my-5 px-8">
														<!--begin::Item-->
														@forelse (auth()->user()->unreadnotifications->where('type','App\Notifications\ProductreturnNotification') as $notification)
                                                            <div class="d-flex flex-stack py-4">
                                                                <!--begin::Section-->
                                                                <div class="d-flex align-items-center">
                                                                    <!--begin::Symbol-->
                                                                    <div class="d-flex align-items-center me-2">
                                                                        ...
                                                                        <!--end::Code-->
                                                                        <!--begin::Title-->
                                                                        <a href="{{route('product.return')}}" class="fs-6 text-gray-800 text-hover-primary fw-bolder"><b>{{$notification->data['product']}}</b>,This Product has a Return Notification</a>
                                                                        <!--end::Title-->
                                                                    </div>
                                                                    <!--end::Symbol-->
                                                                </div>
                                                    ...
                                                    <div class="py-3 text-center border-top">
                                                        ...
                                                        <div>
                                                            <a href="{{route('ordermarkasread.return')}}" class="btn btn-color-gray-600"> Mark as Read </a>
                                                        </div>
                                                    </div>
													<!--end::Items-->
												</div>
											...
											<div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
												...
												<div class="menu-sub menu-sub-dropdown w-175px py-4">
													...
													<div class="menu-item px-3">
														<a href="../../demo1/dist/account/settings.html" class="menu-link d-flex px-5">
														<span class="symbol symbol-20px me-4">
															<img class="rounded-1" src="{{ asset('dashboard_assets') }}/media/flags/germany.svg" alt="" />
														</span>German</a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
														<a href="../../demo1/dist/account/settings.html" class="menu-link d-flex px-5">
														<span class="symbol symbol-20px me-4">
															<img class="rounded-1" src="{{ asset('dashboard_assets') }}/media/flags/japan.svg" alt="" />
														</span>Japanese</a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
														<a href="../../demo1/dist/account/settings.html" class="menu-link d-flex px-5">
														<span class="symbol symbol-20px me-4">
															<img class="rounded-1" src="{{ asset('dashboard_assets') }}/media/flags/france.svg" alt="" />
														</span>French</a>
													</div>
													<!--end::Menu item-->
												</div>
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
												<img src="{{ asset('dashboard_assets') }}/media/avatars/300-14.jpg" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="overflow-auto pb-5">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
												...
												<div class="symbol symbol-circle symbol-25px">
													<img src="{{ asset('dashboard_assets') }}/media/avatars/300-2.jpg" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
													<img src="{{ asset('dashboard_assets') }}/media/avatars/300-20.jpg" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
									...
									<div class="overflow-auto pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
												<img src="{{ asset('dashboard_assets') }}/media/avatars/300-1.jpg" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="mb-5 pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Jan Hummer">
												<img src="{{ asset('dashboard_assets') }}/media/avatars/300-23.jpg" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="overflow-auto pb-5">
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="" class="w-30px me-3" src="{{ asset('dashboard_assets') }}/media/svg/files/pdf.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3" src="{{ asset('dashboard_assets') }}/media/svg/files/doc.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-bold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3" src="{{ asset('dashboard_assets') }}/media/svg/files/css.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-bold">
													<!--begin::Desc-->
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
											...
											<div class="overlay me-10">
												...
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-150px" src="{{ asset('dashboard_assets') }}/media/stock/600x400/img-29.jpg" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
											...
											<div class="overlay me-10">
												<!--begin::Image-->
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-150px" src="{{ asset('dashboard_assets') }}/media/stock/600x400/img-31.jpg" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
											...
											<div class="overlay">
												<!--begin::Image-->
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-150px" src="{{ asset('dashboard_assets') }}/media/stock/600x400/img-40.jpg" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Robert Rich">
												<img src="{{ asset('dashboard_assets') }}/media/avatars/300-4.jpg" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
								...
								<div class="row g-5">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-success rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo1.png" alt="demo" class="w-100" />
											</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo2.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo3.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo4.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo5.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo6.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo7.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo8.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo9.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo10.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo11.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo12.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo13.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo14.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo15.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo16.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo17.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo18.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo19.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo20.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo21.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo22.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo23.png" alt="demo" class="w-100 opacity-25" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{ asset('dashboard_assets') }}/media/demos/demo24.png" alt="demo" class="w-100 opacity-25" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
												<div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
											</div>
							...
							<div class="py-5">
								...
								<div data-kt-search-element="empty" class="text-center d-none">
									...
									<div class="text-center px-5">
										<img src="{{ asset('dashboard_assets') }}/media/illustrations/sketchy-1/1.png" alt="" class="w-100 h-200px h-sm-325px" />
									</div>
									<!--end::Illustration-->
								</div>
								<!--end::Empty-->
		...
		<script src="{{ asset('dashboard_assets') }}/plugins/custom/vis-timeline/vis-timeline.bundle.js"></script>
