					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" method="POST" action="{{ route('login') }}">
							...
							<div class="fv-row mb-10">
								...
								<!--end::Label-->
								<!--begin::Input-->
								<input class="form-control form-control-lg form-control-solid block mt-1 w-full" id="email" type="email" name="email" :value="old('email')" required autofocus  />
							...
							<div class="fv-row mb-10">
								...
								<!--end::Wrapper-->
								<!--begin::Input-->
								<input class="block mt-1 w-full form-control form-control-lg form-control-solid"id="password"
                                type="password"
                                name="password"
