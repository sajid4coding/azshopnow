            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-3 col-lg-4 col-md-5 col-sm-8 order-2 order-md-0">
                    <div class="breadcrumb-product text-center">
                        <div class="thumb">
                            @if ($subCategoryName->thumbnail)
                                <img src="{{ asset('uploads/category_photo') }}/{{$subCategoryName->thumbnail}}" alt="img">
                            @else
                        ...
                        <div class="content">
                            ...
                            <h4 class="title">
                                @if ($categoryName->category_name)
                                    {{$categoryName->category_name}} > {{$subCategoryName->category_name}}
                                @endif
                            </h4>
                    ...
                    <div class="breadcrumb-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{$subCategoryName->category_name}}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
