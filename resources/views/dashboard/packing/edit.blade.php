                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="packaging_name" class="form-control mb-2" value="{{$packaging->packaging_name}}">
                                <!--end::Input-->
                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                ...
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <input class="form-control" name="cost" type="number" value="{{$packaging->cost}}" >
                                <!--end::Editor-->
                            </div>
                            <!--end::Input group-->
                        </div>
