            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <!--begin::Title-->
                        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Blog Create</h1>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                            ...
                            <div class="col-md-8" style="margin-left: 75px !important;">
                                ...
                                <div class="mt-5">
                                    ...
                                    <div>
                                        ...
                                        <input class="form-control mb-5" type="text" name="Meta_Tag_Title" id="Meta_Tag_Title">
                                    </div>
                                    <div>
                                        <label class="form-label">Meta Tag Description</label>
                                        <textarea id="Meta_Tag_Description" class="form-control " name="Meta_Tag_Description" ></textarea>
                                    </div>
                                        <label for="Meta_Tag_Keywords" class="form-label mt-5">Meta Tag Keywords</label>
                                        <input class="js-tag-input" name="Meta_Tag_Keywords" placeholder="Enter new tag..." id="tag-input1"/>
                                        <br>
                                </div>
                                <div class="d-grid gap-2 col-4 mx-auto">
                                    <button class="btn btn-primary mt-5" type="submit">Add Blog</button>
                                </div>
                            </div>
                        </div>
                    </form>
