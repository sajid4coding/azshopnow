...
<div class="d-flex flex-column flex-column-fluid">
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid" data-select2-id="select2-data-kt_app_content">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl" data-select2-id="select2-data-kt_app_content_container">
            <form action="{{ route('subcategory.update',$subcategory->id) }}" method="POST" enctype="multipart/form-data" id="kt_ecommerce_Edit_category_form" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework">
                @csrf
                @method('PATCH')
                <!--begin::Aside column-->
                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{asset('dashboard_assets')}}/media/svg/avatars/blank.svg')">
                                <!--begin::Preview existing avatar-->
                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ asset('uploads/category_photo/sub_category_photo') }}/{{ $subcategory->thumbnail }}')"></div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select name="status" class="form-select mb-2 select2-hidden-accessible" data-control="select2">
                                <option value="published" @if ($subcategory->status == "published") selected="selected" @endif>Published</option>
                                <option value="unpublished" @if ($subcategory->status == "unpublished") selected="selected" @endif>Unpublished</option>
                            </select>
                            <!--end::Select2-->
                            <!--begin::Description-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="category_name" class="form-control mb-2" placeholder="Product name" value="{{ $subcategory->category_name }}">
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                ...
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <input class="form-control" name="slug" placeholder="Product slug" type="text" value="{{ $subcategory->slug }}">
                                <!--end::Editor-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                ...
                                <select class="form-select" name="parent_category_slug">
                                    <option selected value="{{ $subcategory->parent_category_slug }}">{{ $subcategory->relationshipwith_parent_category->category_name }}</option>
                            ...
                            <div>
                                ...
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <textarea class="form-control" name="description" cols="10" rows="10">{{ $subcategory->description }}</textarea>
                                <!--end::Editor-->
                                <!--begin::Description-->
