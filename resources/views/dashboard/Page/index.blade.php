                        ...
                        <div class="table-responsive">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    <th class="min-w-250px sorting">Page Name</th>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <div class="ms-5">
                                                    <!--begin::Title-->
                                                    <a href="{{ route('pages.edit', $page->id) }}" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1">{{ $page->page_title }}</a>
                                                    <!--end::Title-->
                                                    <!--begin::Description-->
                                                    <div class="text-muted fs-7 fw-bold">{{ Str::limit($page->description, 100) }}</div>
                                                    <!--end::Description-->
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            @if ($page->status == 'unpublished')
                                                <div class="badge badge-light-danger">{{ Str::title($page->status) }}</div>
                                            @else
                                                <div class="badge badge-light-success">{{ Str::title($page->status) }}</div>
                                            @endif
                                            <!--end::Badges-->
                                        </td>
                                        <!--end::Type=-->
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('pages.edit', $page->id) }}" class="btn btn-sm menu-link px-3">Edit</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
