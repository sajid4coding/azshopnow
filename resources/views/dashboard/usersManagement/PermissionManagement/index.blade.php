                ...
                <div class="card-body pt-0">
                    ...
                    <div id="kt_ecommerce_category_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="table-responsive">
                            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="permission_table">
                            <!--begin::Table head-->
                            <thead>
                                <!--begin::Table row-->
                                    <th>SL</th>
                                    <th class="min-w-250px sorting">Permission Name</th>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('permission.edit', $Permission->id) }}" class="menu-link  btn btn-sm px-3">Edit</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <form class="form-prevent-multiple-submits" action="{{ route('permission.destroy', $Permission->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
