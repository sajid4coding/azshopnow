                    ...
                    <div class="card-body pt-0">
                        ...
                        <div id="kt_ecommerce_category_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="table-responsive">
                                ...
                                <thead>
                                    <!--begin::Table row-->
                                        <th class="min-w-250px sorting">Customer email</th>
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ms-5">
                                                        <!--begin::Title-->
                                                        <a href="" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1">{{ $newsletter->email }}</a>
                                                        <!--end::Title-->
                                                        <!--begin::Description-->
