                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10">
                            <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
                                ...
                                <div class="card card-flush py-4 flex-row-fluid overflow-hidden">
                                    ...
                                    <!--end::Card header-->
                                    <!--begin::Card body-->
                                    {{-- <div class="card-body pt-0"><strong>Name : </strong> {{ $invoice->billing_first_name }}</div>
                                    <div class="card-body pt-0"><strong>State : </strong></div>
                                    <div class="card-body pt-0"><strong>Address : </strong> {{ $invoice->billing_address }}</div> --}}
                                    <!--end::Card body-->
                                </div>
